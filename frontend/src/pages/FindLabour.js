...
const DIST = {
  "Uttar Pradesh":["Lucknow","Agra","Varanasi","Kanpur","Gorakhpur","Meerut","Noida","Ghaziabad","Bareilly","Allahabad"],
  "Maharashtra":["Mumbai","Pune","Nagpur","Nashik","Aurangabad","Solapur","Thane","Kolhapur","Amravati","Nanded"],
  "Rajasthan":["Jaipur","Jodhpur","Udaipur","Kota","Bikaner","Ajmer","Alwar","Barmer","Sikar","Churu"],
  "Bihar":["Patna","Gaya","Muzaffarpur","Bhagalpur","Darbhanga","Purnia","Arrah","Begusarai","Munger","Chapra"],
  ...
  "Haryana":["Gurugram","Faridabad","Ambala","Panipat","Rohtak","Karnal","Sonipat","Yamunanagar","Hisar","Panchkula"],
  "Punjab":["Ludhiana","Amritsar","Jalandhar","Patiala","Bathinda","Hoshiarpur","Mohali","Pathankot","Moga","Firozpur"],
  "Delhi":["Central Delhi","East Delhi","New Delhi","North Delhi","North East Delhi","Shahdara","South Delhi","West Delhi"],
  "West Bengal":["Kolkata","Howrah","Darjeeling","Siliguri","Asansol","Durgapur","Bardhaman","Malda","Cooch Behar","Jalpaiguri"],
  "Odisha":["Bhubaneswar","Cuttack","Berhampur","Rourkela","Sambalpur","Puri","Balasore","Bhadrak","Kendujhar","Koraput"],
